...
BEGIN
    ...
    -- Obtenemos la Vida del Villano
	SELECT vida INTO v_vida FROM villano WHERE id=h_id;
    ...
    SELECT defensa_p INTO deff_p FROM villano WHERE id=h_id;
    SELECT defensa_m INTO deff_m FROM villano WHERE id=h_id;
